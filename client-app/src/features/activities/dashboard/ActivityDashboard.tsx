...
const ActivityDashboard: React.FC<IProps> = ({ activities, selectActivity, selectedActivity, editMode, setEditMode, setSelectedActivity }) => {
  return (
    <Grid>
        ...
        <Grid.Column width={6}>
            {selectedActivity && !editMode &&  <ActivityDetails cancelSelectedActivity={setSelectedActivity} editMode={editMode} selectedActivity={selectedActivity} setEditForm={setEditMode} />}
